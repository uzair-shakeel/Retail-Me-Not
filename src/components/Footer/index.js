         ...
         <div className="col">
          ...
          <div className="col">
            <ul>
              <li>GET INVOLVED</li>
              <li>
                <Link>The Real Deal</Link>
              </li>
              <li>
                <Link>Community</Link>
              </li>
              <li>
                <Link>Submit a Coupon</Link>
              </li>
              <li>
          ...
          <div className="col">
            <ul>
              ...
              <li>
                <Link>Deal Finder</Link>
              </li>
              <li>
                <Link>RetailMeNot Canada</Link>
              </li>
              <li>
                <Link>About</Link>
              </li>
          ...
          <div className="col_app">
            <img src={footerLogo} alt="logo" />
            <div className="col-app-links">
              <Link>Get Savings on to go!</Link>
              <Link><b>Download the App</b></Link>
            </div>
          </div>
        </div>
        <div className="links">
          ...
          <Link>Do Not Sell My Personal Infomation</Link>
          <Link>Accessibility Statement</Link>
          <Link>Sitemap</Link>
          <Link>©2006-2023 RetailMeNot, Inc., a Ziff Davis company.</Link>
        </div>
        <div>
          <p className="footer_details">
            All rights reserved. RetailMeNot and RMN are registered trademarks
            of RetailMeNot, Inc. Third-party trademarks are the property of
            their respective third-party owners. Presence of a third-party
            trademark does not mean that RetailMeNot has any relationship with
            that third-party or that the third-party endorses RetailMeNot or its
            services.
          </p>
        </div>
      </div>
